...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top">
    <div class="container">
        <a class="navbar-brand fw-semibold" href="<?= BASE_URL ?>/home">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
                ...
                <?php if ($user): ?>
                    ...
                    <?php if ($isStaff): ?>
                        <li class="nav-item">
                            <a class="btn btn-outline-secondary btn-sm px-3" href="<?= BASE_URL ?>/admin">Espace gestion</a>
                        </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item text-danger" href="<?= BASE_URL ?>/logout">Déconnexion</a></li>
                        </ul>
                    </li>
                <?php else: ?>
